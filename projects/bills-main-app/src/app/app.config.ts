...
import { AuthService, BillsService, OverviewBillsService, PaymentsService } from 'projects/model/src/public-api';
...
import { BillsServiceImpl, OverviewBillsServiceImpl, PaymentsServiceImpl } from './services';
